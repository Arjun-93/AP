...
import static company.ass2.ProductCatalog;
import static company.ass2.ctg;
...
class customer implements I1{
    ...
    private final ArrayList<Integer> coupounList;
    ...
    public void setbalance(double newBalance){
        ...
        coupounList.sort(Collections.reverseOrder());
    }
...
interface ctg_interface{
    ...
    default void errorMessage_category(){
        System.out.println("Category can't be added , Please add a products ");
    }
    default void errorMessage_product(){
...
abstract class product{
    ...
    public abstract void displayProduct(Groceries_vegetables g);
}
class HomeAppliances extends product implements I1{
    private double capacity;
    private double powerConsumption;
    private final ArrayList<Double> discount;
